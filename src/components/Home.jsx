...
function Home({ onNavigate }) {
  return (
    <div className="relative min-h-[500px] w-full max-w-md flex items-center justify-center animate-fade-in">
      ...
      <div className="absolute top-0 -right-4 w-72 h-72 bg-sprout-pink rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" style={{ animationDelay: '2s' }}></div>
      <div className="absolute -bottom-8 left-20 w-72 h-72 bg-sprout-blue rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" style={{ animationDelay: '4s' }}></div>
