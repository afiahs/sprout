  ...
  return (
    <div className="max-w-md w-full bg-white rounded-[2rem] shadow-sm p-8 border border-gray-100">
      ...
      <div className="flex flex-col gap-4">
        {/* Brain Dump Button */}
        <button className="bg-sprout-peach bg-opacity-40 hover:bg-opacity-60 text-sprout-text py-4 px-6 rounded-2xl font-medium transition-all flex items-center justify-between w-full">
        ...
        {/* Timer Button */}
        <button className="bg-gray-100 hover:bg-gray-200 text-sprout-text py-4 px-6 rounded-2xl font-medium transition-all flex items-center justify-between w-full">
